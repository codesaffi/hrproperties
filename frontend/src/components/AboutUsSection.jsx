        ...
        <div className=" flex flex-col items-center text-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-700 leading-relaxed text-xl md:text-2xl text-center mb-10">
              Our mission is to{" "}
              <span className="font-bold">
                redefine real estate in Pakistan
              </span>{" "}
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="text-gray-700 leading-relaxed text-xl md:text-2xl space-y-2 text-center mb-10">
              ...
              <p>
                <span className="font-bold">Excellence:</span> Setting new
                standards in planning, infrastructure, and customer care.
              </p>
              <p>
                <span className="font-bold">Sustainability:</span> Eco-conscious
                development for a healthier tomorrow.
              </p>
              <p>
              ...
              <p>
                At HR Properties, we don’t just build projects — we{" "}
                <span className="font-bold">
                  build trust, secure futures, and create lasting value.
                </span>
              </p>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto px-6 flex flex-col items-center mb-16">
            ...
            <div className="w-full flex flex-col md:flex-row items-center justify-center gap-10 md:gap-20">
              {items.map((item, i) => (
                <div
                  key={i}
                  className="flex flex-col items-center text-center bg-white rounded-xl shadow-md p-6 w-full md:w-1/3"
                >
                  <img
                    src={item.icon}
