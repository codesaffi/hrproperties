  ...
  <div className="w-full px-2 md:px-8 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div className="order-2 md:order-1 text-left">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            At <span className="font-semibold text-blue-800">HR Properties</span>,
            our mission has always been to redefine real estate in Pakistan
            through <span className="font-semibold">trust, transparency, and value-driven development</span>.
            As CEO, I am deeply committed to creating communities that not only
            provide homes but also ensure{" "}
            <span className="font-semibold">long-term investment security and lifestyle excellence</span>.
            Every project we deliver is a reflection of our promise—
            <span className="font-semibold">LDA-approved, sustainable, and customer-focused</span>—
            because we believe our clients deserve nothing less than the very best.
          </p>

          <p className="text-gray-700 leading-relaxed mb-4">
            Together, we are building more than just properties; we are shaping{" "}
            <span className="font-semibold">secure futures and thriving communities</span> 
