        ...
        <div className="flex items-center space-x-4 relative">
          {user ? (
            <div className="relative">
              <button className="flex items-center space-x-3" onClick={() => setUserOpen((v) => !v)}>
            ...
            <Link to="/login" className="flex items-center space-x-2 focus:outline-none" aria-label="Login">
